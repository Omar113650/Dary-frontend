          ...
          <div className="auth-form-container">
            <div className="auth-form-header">
              <div className="auth-eyebrow-wrap">
                ...
                <span className="auth-eyebrow">{t.auth_register_eyebrow}</span>
              </div>
            ...
            <form className="auth-form" onSubmit={handleSubmit} noValidate>
              ...
              >
                {isLoading ? (
                  <>
                    ...
                    <span>{locale === 'ar' ? 'جاري الإنشاء...' : 'Creating account...'}</span>
                  </>
                ) : (
                  <span>{t.auth_register_button}</span>
                )}
              </button>
              ...
              >
                ...
                <span>{t.auth_google_register}</span>
              </button>
            </form>
